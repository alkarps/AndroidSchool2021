...
class ConverterAdapter(
    ...
    private var values: List<QuantityValue> = converter.startList(quantity.units)
    ...
    private fun setFirst(mustBeFirst: QuantityValue) {
    ...
    private fun update(new: List<QuantityValue>) {
