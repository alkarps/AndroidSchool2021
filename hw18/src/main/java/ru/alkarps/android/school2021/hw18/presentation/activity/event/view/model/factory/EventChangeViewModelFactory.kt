...
/**
 * Фабрика [EventChangeViewModel]
 *
 * @constructor Новый инстанс [ViewModelProvider.Factory]
 */
@HolidayMainScope
class EventChangeViewModelFactory @Inject constructor(
    private val schedulersProvider: SchedulersProvider,
    private val eventsController: EventsController
) : ViewModelProvider.Factory {
    /**
     * Метод создания [EventChangeViewModel]
     *
     * @param T [ViewModel]
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        return EventChangeViewModel(schedulersProvider, eventsController) as T
    }
}